...
import {IRegisterForm} from "../utils/interface";

import * as yup from "yup"
import {yupResolver} from '@hookform/resolvers/yup';
import {useAppDispatch, useAppSelector} from "../app/hooks";
import {userRegisterThunk} from "../features/userSlice";
...
const RegisterPage = () => {
    ...
    const registerFormValidation = yup.object({
        ...
        name: yup.string().required("This field con not be empty").min(6, "Field must be more 5 length"),
    ...
    const handleSubmitRegisterForm: SubmitHandler<IRegisterForm> = (data) => {
        dispatch(userRegisterThunk(data)).then((response: any) => {
            ...
            <Box className={classes.RegisterPageContainer} component="form"
                ...
                <Controller control={control} defaultValue=""
                            render={({field: {value, onChange}, fieldState: {error}}) => (
                                <TextField placeholder="Please enter name" className={classes.RegisterPageInput}
